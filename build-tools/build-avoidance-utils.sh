...
get_build_avoidance_context () {
    ...
    # Set BUILD_AVOIDANCE_URL, it will be used in other functions
    BUILD_AVOIDANCE_URL=$BUILD_AVOIDANCE_HOST:$BA_CONTEXT_DIR

    # return BUILD_AVOIDANCE_URL to caller
    echo $BUILD_AVOIDANCE_URL
    return 0
    )
}
...
#
# A place for any cleanup actions that must preceed a build avoudance build.
#
