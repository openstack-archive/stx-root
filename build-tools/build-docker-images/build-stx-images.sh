...
function post_build {
    ...
    # Default TIS_PATCH_VER to 0, if not set
    local -i TIS_PATCH_VER
    TIS_PATCH_VER=$(source ${image_build_file} && echo ${TIS_PATCH_VER:-0})

    local IMAGE_TAG_VERSIONED="${IMAGE_TAG}.${TIS_PATCH_VER}"
